import type { FollowingProfileCard, IconName, Post, PostReply } from "../../app.types";

export type AuthorProfileTab = "likes" | "posts" | "replies" | "predictions" | "bio";

export type AuthorProfileSectionVisibility = Record<AuthorProfileTab, boolean>;

export type AuthorProfileSectionNoticeDismissal = Record<AuthorProfileTab, boolean>;
